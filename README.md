...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=SvenVw_rvo-connector&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=SvenVw_rvo-connector) [![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=SvenVw_rvo-connector&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=SvenVw_rvo-connector) [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=SvenVw_rvo-connector&metric=coverage)](https://sonarcloud.io/summary/new_code?id=SvenVw_rvo-connector) [![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=SvenVw_rvo-connector&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=SvenVw_rvo-connector)
